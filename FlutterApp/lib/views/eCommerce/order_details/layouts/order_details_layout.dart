...
import 'package:ready_ecommerce/models/eCommerce/shop_message_model/shop.dart' as shop;
                    ...
                    children: [
                      ...
                      CustomButton(
                          ...
                          buttonColor: isEnableNextButton == true
                              ...
                              : colors(context).primaryColor!.withValues(alpha: 0.5),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: SvgPicture.asset(
                    Assets.svg.message,
                    colorFilter: ColorFilter.mode(colors(context).primaryColor!, BlendMode.srcIn),
                    // width: 16.w,
                    // height: 16.h,
                  ),
                ),
