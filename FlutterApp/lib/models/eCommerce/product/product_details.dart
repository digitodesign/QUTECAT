...
class ProductDetails {
  ...
  final List<product_model.Product>? relatedProducts;
  ProductDetails({
  ...
  ProductDetails copyWith({
    Product? product,
    List<product_model.Product>? relatedProducts,
  }) {
  ...
  factory ProductDetails.fromMap(Map<String, dynamic> map) {
    return ProductDetails(
      ...
      relatedProducts: List<product_model.Product>.from(
        (map['related_products'] as List<dynamic>).map<product_model.Product>(
          (x) => product_model.Product.fromMap(x as Map<String, dynamic>),
        ),
      ),
    );
  }
